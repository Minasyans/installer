...
@section('content')
    ...
    @foreach($requirements['requirements'] as $type => $requirement)
        <ul class="w-full rounded-lg mt-2 mb-3 text-gray-800 font-semibold">
            <li class="mb-1">
        ...
        <div class="fixed bottom-0 left-0 right-0 py-5 bg-white shadow-md">
            <div class="max-w-3xl mx-auto px-4">
                <div class="flex justify-center">
                    <a href="{{ route('Installer::permissions') }}" class="focus:outline-none border border-transparent py-2 px-5 rounded-lg shadow-sm text-center text-white bg-blue-500 hover:bg-blue-600 font-medium">
